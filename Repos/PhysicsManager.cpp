...
/*
bool PhysicsManager::IsColliding(PhysEntity* entity1, PhysEntity* entity2)
{
	if (entity1->GetLayer() == CollisionLayers::None || entity2->GetLayer() == CollisionLayers::None)
	{
		return false;
	}

	if ((mLayerMasks[(int)entity1->GetLayer()] & (int)entity2->GetFlags()) != 0)
	{
		return true;
	}

	if ((mLayerMasks[(int)entity2->GetLayer()] & (int)entity1->GetFlags()) != 0)
	{
		return true;
	}
